...
return [
    ...
    'phpOMS\tests\DataStorage\Session\FileSessionTest'                          => ['description' => 'Session data handler for http sessions', 'type' => 'framework'],
    'phpOMS\tests\DataStorage\Session\FileSessionTest:testDefault'              => ['description' => 'The session has the expected default values after initialization', 'type' => 'framework'],
    'phpOMS\tests\DataStorage\Session\FileSessionTest:testInputOutput'          => ['description' => 'Session data can be set and returned', 'type' => 'framework'],
    'phpOMS\tests\DataStorage\Session\FileSessionTest:testOverwrite'            => ['description' => 'Session data can be forced to overwrite', 'type' => 'framework'],
    'phpOMS\tests\DataStorage\Session\FileSessionTest:testInvalidOverwrite'     => ['description' => 'Session data cannot be overwritten', 'type' => 'framework'],
    'phpOMS\tests\DataStorage\Session\FileSessionTest:testRemove'               => ['description' => 'Session data can be removed', 'type' => 'framework'],
