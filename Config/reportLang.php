...
return [
    ...
    // models
    'Modules\tests\News\Models\NewsArticleTest' => ['description' => 'News article', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testDefault' => ['description' => 'The model has the expected default values after initialization', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testCreatorInputOutput' => ['description' => 'The cretor can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testTitleInputOutput' => ['description' => 'The title can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testContentInputOutput' => ['description' => 'The content can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testPlainInputOutput' => ['description' => 'The plain content can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testPublishInputOutput' => ['description' => 'The publish date can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testFeaturedInputOutput' => ['description' => 'The featured flag can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testLanguageInputOutput' => ['description' => 'The language can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testStatusInputOutput' => ['description' => 'The status can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testTypeInputOutput' => ['description' => 'The type can be correctly set and returned', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testSerialization' => ['description' => 'The model can be correctly serialized', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testInvalidStatus' => ['description' => 'A invalid status throws a InvalidEnumValue exception', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testInvalidType' => ['description' => 'A invalid type throws a InvalidEnumValue exception', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleTest:testInvalidLanguage' => ['description' => 'A invalid language throws a InvalidEnumValue exception', 'type' => 'module'],

    'Modules\tests\News\Models\NewsArticleMapperTest' => ['description' => 'News article mapper', 'type' => 'module'],
    'Modules\tests\News\Models\NewsArticleMapperTest:testDefault' => ['description' => 'The model can be created and read from the database', 'type' => 'module'],
